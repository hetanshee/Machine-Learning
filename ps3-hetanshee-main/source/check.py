...
def cv_performance_one_trial(clf,train_data, kf):
    ...
    train_error = 0
    count = 0
    # x_tr,x_ts,y_tr,y_ts= train_test_split(train_data, y, test_size=0.3)
...
def main():
    ...
    r1, r2 = cv_performance(P, train_data, kfs)
    print(f'    P    {r1:9.3f} {r2:9.3f} ')
    r3, r4 = cv_performance(L, train_data, kfs)
    print(f'    L    {r3:9.3f} {r4:9.3f} ')
    r5, r6 = cv_performance(R, train_data, kfs)
