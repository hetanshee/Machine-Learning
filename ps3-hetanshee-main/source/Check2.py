...
def main():
    ...
    print
    "coefs = %s, iteration = %s" % (clf.coef_, clf.n_iter_)
    ### ========== TODO : END ========== ###
    ...
    print
    "Descriptive stats in the order: Dummy, Perceptron, Logistic"
    print
    descriptive_stats
    ...
    print
    "Dummy vs Perceptron p = ", pvalues[0]
    print
    "Dummy vs Logistic p = ", pvalues[1]
    print
    "Perceptron vs Logistic p = ", pvalues[2]
    ...
    print
    "Scaled Dummy vs Perceptron p = ", pvalues_scaled[0]
    print
    "Scaled Dummy vs Logistic p = ", pvalues_scaled[1]
    print
    "Scaled Perceptron vs Logistic p = ", pvalues_scaled[2]
    ...
    print
    "Dummy Row vs Elements in Standardized"
    print
    "D vs Standard D", pval_d[0]
    print
    "D vs Standard P", pval_d[1]
    print
    "D vs Standard L", pval_d[2]
    ...
    print
    "Perceptron Row vs Elements in Standardized"
    print
    "P vs Standard D", pval_p[0]
    print
    "P vs Standard P", pval_p[1]
    print
    "P vs Standard L", pval_p[2]
    ...
    print
    "Logistic Row vs Elements in Standardized"
    print
    "L vs Standard D", pval_r[0]
    print
    "L vs Standard P", pval_r[1]
    print
    "L vs Standard L", pval_r[2]

    # print out descriptive_stats
    print
    "Descriptive scaled stats in the order: Dummy, Perceptron, Logistic"
    print
    descriptive_stats_scaled
